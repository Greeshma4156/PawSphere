...
import { Activity, ShieldAlert, Award, Sparkles, AlertCircle, Heart } from 'lucide-react'
    ...
    <section className="py-16 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[220px]">
        ...
        <motion.div 
          ...
          whileHover={{ y: -5 }}
        >
          <div className="absolute -right-10 -bottom-10 w-44 h-44 bg-lavender/10 rounded-full blur-2xl"></div>
          <div>
            <div className="w-10 h-10 bg-lavender text-white rounded-2xl flex items-center justify-center mb-4">
              <ShieldAlert className="w-5 h-5" />
            </div>
            <h3 className="text-xl font-bold font-outfit text-dark dark:text-cream">Instant GPS Emergency Dispatch</h3>
        ...
        <motion.div 
          ...
          whileHover={{ y: -5 }}
        >
          <div className="absolute -left-10 -bottom-10 w-44 h-44 bg-peach/20 rounded-full blur-2xl"></div>
          <div>
            <div className="w-10 h-10 bg-peach text-orange-800 rounded-2xl flex items-center justify-center mb-4">
              <Heart className="w-5 h-5" />
            </div>
            <h3 className="text-xl font-bold font-outfit text-dark dark:text-cream">Transparent Medical Campaigns</h3>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1.5 max-w-md leading-relaxed">
